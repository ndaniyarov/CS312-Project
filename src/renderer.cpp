...
void Renderer::animated(bool is)
{
   mAnimated = is;
}
...
void Renderer::quad(const glm::vec3 &pos, const glm::vec4 &color, float size)
{
   ...
   glUniform1f(glGetUniformLocation(mShaderId, "uRows"), 4.0f);
   glUniform1f(glGetUniformLocation(mShaderId, "uCols"), 8.0f);
   ...
   if (mAnimated)
   {
      ...
      glUniform1f(glGetUniformLocation(mShaderId, "c"), c);
      glUniform1f(glGetUniformLocation(mShaderId, "r"), r);
      glDrawArrays(GL_TRIANGLES, 0, 6);
   }
   else
   {
      glUniform1f(glGetUniformLocation(mShaderId, "c"), 0);
      glUniform1f(glGetUniformLocation(mShaderId, "r"), 0);
      glUniform1f(glGetUniformLocation(mShaderId, "uRows"), 1.0f);
      glUniform1f(glGetUniformLocation(mShaderId, "uCols"), 1.0f);
      glDrawArrays(GL_TRIANGLES, 0, 6);
   }
}
